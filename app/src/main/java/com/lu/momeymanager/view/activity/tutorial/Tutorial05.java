package com.lu.momeymanager.view.activity.tutorial;
...
import com.lu.momeymanager.view.activity.angle.AngleCircleCollider;
import com.lu.momeymanager.view.activity.angle.AngleObject;
import com.lu.momeymanager.view.activity.angle.AnglePhysicObject;
import com.lu.momeymanager.view.activity.angle.AnglePhysicsEngine;
import com.lu.momeymanager.view.activity.angle.AngleSegmentCollider;
...
import com.lu.momeymanager.view.activity.angle.FPSCounter;
...
public class Tutorial05 extends AngleActivity
{
   ...
   private final SensorEventListener mListener = new SensorEventListener() 
   {
	...
	private class MyDemo extends AngleUI
	{
		...
		{
			super(activity);
//			mBallLayout = new AngleSpriteLayout(mGLSurfaceView, 64, 64, R.drawable.ball, 0, 0, screeW, screenH);
			...
			//>Aadimos 2 colisionadores de segmento para simular las paredes
			AnglePhysicObject mWall = new AnglePhysicObject(1, 0);
			mWall.mPosition.set(160, screenH);
//			mWall.mPosition.set(160, 479);
			...
			mWall = new AnglePhysicObject(1, 0);
			mWall.mPosition.set(screenH, 240);
//			mWall.mPosition.set(319, 240);
		...
		public boolean onTouchEvent(MotionEvent event)
		{
			...
			{
				if ((event.getX()>30)&&(event.getY()>30)&&(event.getX()<screeW-30)&&(event.getY()<screenH-30))
				{
...
//		mGLSurfaceView.setBackgroundColor(Color.WHITE);
