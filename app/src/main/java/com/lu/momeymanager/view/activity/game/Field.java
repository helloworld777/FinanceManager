...
public class Field extends AngleObject
{
	...
	{
		super(100); //99 smileys como m�ximo + 1 fondo
		mGame=game;
	...
	//>PASO 29:
	//>Sobrecargamos el m�todo draw para dibujar de forma diferente a la habitual.
	@Override
	public void draw(GL10 gl)
	{
		...
		//>despu�s dibujamos los smileys del �ltimo que se insert� al 1�
	...
	//>PASO 30: (FIN)
	//>El resto de c�digo es b�sicamente la l�gica del juego.
