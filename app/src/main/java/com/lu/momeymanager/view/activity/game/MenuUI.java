...
public class MenuUI extends AngleUI
{
	...
	public MenuUI(AngleActivity activity)
	{
		...
		addObject(new AngleSprite(160, 240, new AngleSpriteLayout(mActivity.mGLSurfaceView, 320, 480, R.drawable.bg_menu)));
		//Step by step:
		...
		//>En el caso actual, no seria necesario, pero si m�s adelante queremos a�adir otros objetos sobre el fondo y bajo los textos para conseguir algunos efectos visuales,
		//>ya lo tenemos.
